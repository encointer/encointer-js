...
import type { Bytes, Null, Option, Result, U8aFixed, bool, i32, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetTxPayment: {
       ...
       **/
      AssetTxFeePaid: AugmentedEvent<ApiType, [who: AccountId32, actualFee: u128, tip: u128, assetId: Option<EncointerPrimitivesCommunitiesCommunityIdentifier>], { who: AccountId32, actualFee: u128, tip: u128, assetId: Option<EncointerPrimitivesCommunitiesCommunityIdentifier> }>;
      /**
       * Generic event
       **/
    ...
    encointerBalances: {
       ...
       **/
      Endowed: AugmentedEvent<ApiType, [cid: EncointerPrimitivesCommunitiesCommunityIdentifier, who: AccountId32, balance: SubstrateFixedFixedI128], { cid: EncointerPrimitivesCommunitiesCommunityIdentifier, who: AccountId32, balance: SubstrateFixedFixedI128 }>;
      /**
       * fee conversion factor updated successfully
       **/
      FeeConversionFactorUpdated: AugmentedEvent<ApiType, [u128]>;
      /**
       * Token issuance success `[community_id, beneficiary, amount]`
       **/
      Issued: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, SubstrateFixedFixedI128]>;
      /**
       * Token transfer success `[community_id, from, to, amount]`
       **/
      Transferred: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, AccountId32, SubstrateFixedFixedI128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    encointerBazaar: {
       ...
       **/
      BusinessCreated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32]>;
      /**
       * Event emitted when a business is deleted. [community, who]
       **/
      BusinessDeleted: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32]>;
      /**
       * Event emitted when a business is updated. [community, who]
       **/
      BusinessUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32]>;
      /**
       * Event emitted when an offering is created. [community, who, oid]
       **/
      OfferingCreated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, u32]>;
      /**
       * Event emitted when an offering is deleted. [community, who, oid]
       **/
      OfferingDeleted: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, u32]>;
      /**
       * Event emitted when an offering is updated. [community, who, oid]
       **/
      OfferingUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, u32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    encointerCeremonies: {
       ...
       **/
      AttestationsRegistered: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, u64, u32, AccountId32]>;
      /**
       * the registry for given ceremony index and community has been purged
       **/
      CommunityCeremonyHistoryPurged: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, u32]>;
      /**
       ...
       **/
      EndorsedParticipant: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, AccountId32, AccountId32]>;
      /**
       * The number of endorsement tickets which bootstrappers can give out has changed
       **/
      EndorsementTicketsPerBootstrapperUpdated: AugmentedEvent<ApiType, [u8]>;
      /**
       * The number of endorsement tickets which bootstrappers can give out has changed
       **/
      EndorsementTicketsPerReputableUpdated: AugmentedEvent<ApiType, [u8]>;
      /**
       * The inactivity counter of a community has been increased
       **/
      InactivityCounterUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, u32]>;
      /**
       * inactivity timeout has changed. affects how many ceremony cycles a community can be idle before getting purged
       **/
      InactivityTimeoutUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * meetup location tolerance changed [m]
       **/
      LocationToleranceUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * Result of the meetup at the previous ceremony
       **/
      MeetupEvaluated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, u64, EncointerPrimitivesCeremoniesMeetupResult]>;
      /**
       * meetup time offset has changed. affects the exact time the upcoming ceremony meetups will take place
       **/
      MeetupTimeOffsetUpdated: AugmentedEvent<ApiType, [i32]>;
      NoReward: AugmentedEvent<ApiType, [cid: EncointerPrimitivesCommunitiesCommunityIdentifier, cindex: u32, meetupIndex: u64, account: AccountId32, reason: EncointerMeetupValidationExclusionReason], { cid: EncointerPrimitivesCommunitiesCommunityIdentifier, cindex: u32, meetupIndex: u64, account: AccountId32, reason: EncointerMeetupValidationExclusionReason }>;
      /**
       * Participant registered for next ceremony [community, participant type, who]
       **/
      ParticipantRegistered: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, EncointerPrimitivesCeremoniesParticipantType, AccountId32]>;
      /**
       * reputation lifetime has changed. After this many ceremony cycles, reputations is outdated
       **/
      ReputationLifetimeUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * rewards have been claimed and issued successfully for N participants for their meetup at the previous ceremony
       **/
      RewardsIssued: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, u64, u8]>;
      /**
       * meetup time tolerance has changed
       **/
      TimeToleranceUpdated: AugmentedEvent<ApiType, [u64]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    encointerCommunities: {
       ...
       **/
      CommunityPurged: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier]>;
      /**
       * A new community was registered [community_identifier]
       **/
      CommunityRegistered: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier]>;
      /**
       * A community's demurrage was updated [community_identifier, new_demurrage]
       **/
      DemurrageUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, SubstrateFixedFixedI128]>;
      /**
       * A location has been added
       **/
      LocationAdded: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, EncointerPrimitivesCommunitiesLocation]>;
      /**
       * A location has been removed
       **/
      LocationRemoved: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, EncointerPrimitivesCommunitiesLocation]>;
      /**
       * A security parameter for minimum meetup location distance has changed
       **/
      MaxSpeedMpsUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * CommunityMetadata was updated [community_identifier]
       **/
      MetadataUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier]>;
      /**
       * A security parameter for minimum meetup location distance has changed
       **/
      MinSolarTripTimeSUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * A community's nominal income was updated [community_identifier, new_income]
       **/
      NominalIncomeUpdated: AugmentedEvent<ApiType, [EncointerPrimitivesCommunitiesCommunityIdentifier, SubstrateFixedFixedI128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    encointerScheduler: {
      CeremonySchedulePushedByOneDay: AugmentedEvent<ApiType, []>;
      /**
       * Phase changed to `[new phase]`
       **/
      PhaseChangedTo: AugmentedEvent<ApiType, [EncointerPrimitivesSchedulerCeremonyPhaseType]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: EncointerRuntimeProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: EncointerRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: EncointerRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: EncointerRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: EncointerRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: EncointerRuntimeProxyType, delay: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;

...
import type { AccountInfoAndSessionProxies, AddSessionProxyArgs, AssetBalanceArg, AssetsShieldArgs, AssetsTransferArgs, AssetsTransferWithNoteArgs, AssetsUnshieldArgs, AttemptsArg, BalanceShieldArgs, BalanceShieldThroughEnclaveBridgePalletArgs, BalanceTransferArgs, BalanceTransferWithNoteArgs, BalanceUnshieldArgs, BalanceUnshieldThroughEnclaveBridgePalletArgs, BucketIndex, BucketInfo, GuessArgs, GuessTheNumberInfo, GuessTheNumberPublicGetter, GuessTheNumberSetWinningsArgs, GuessTheNumberTrustedCall, GuessTheNumberTrustedGetter, GuessType, IntegriteeGetter, IntegriteePublicGetter, IntegriteeTrustedCall, IntegriteeTrustedCallSigned, IntegriteeTrustedGetter, IntegriteeTrustedGetterSigned, IntegriteeTrustedOperation, NoteIndex, NotesBucketInfo, NotesForArgs, SendNoteArgs, SessionProxyCredentials, SessionProxyRole, TimestampSetArgs, TimestampedTrustedNote, TrustedNote } from '@encointer/types/interfaces/integriteeWorker';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    AssetBalanceArg: AssetBalanceArg;

...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    CandidatePendingAvailablility: CandidatePendingAvailability;
    'Option<CandidatePendingAvailablility>': Option<CandidatePendingAvailability>;
    'Vec<CandidatePendingAvailablility>': Vec<CandidatePendingAvailability>;
    ...
    'Vec<CeremonyIndexType>': Vec<CeremonyIndexType>;
    CeremonyPhaseType: CeremonyPhaseType;
    'Option<CeremonyPhaseType>': Option<CeremonyPhaseType>;
    'Vec<CeremonyPhaseType>': Vec<CeremonyPhaseType>;
    ParticipantIndexType: ParticipantIndexType;
    'Compact<ParticipantIndexType>': Compact<ParticipantIndexType>;
    'Option<ParticipantIndexType>': Option<ParticipantIndexType>;
    'Vec<ParticipantIndexType>': Vec<ParticipantIndexType>;
    MeetupIndexType: MeetupIndexType;
    'Compact<MeetupIndexType>': Compact<MeetupIndexType>;
    'Option<MeetupIndexType>': Option<MeetupIndexType>;
    'Vec<MeetupIndexType>': Vec<MeetupIndexType>;
    AttestationIndexType: AttestationIndexType;
    'Compact<AttestationIndexType>': Compact<AttestationIndexType>;
    'Option<AttestationIndexType>': Option<AttestationIndexType>;
    'Vec<AttestationIndexType>': Vec<AttestationIndexType>;
    Location: Location;
    'Option<Location>': Option<Location>;
    'Vec<Location>': Vec<Location>;
    MeetupAssignment: MeetupAssignment;
    'Option<MeetupAssignment>': Option<MeetupAssignment>;
    'Vec<MeetupAssignment>': Vec<MeetupAssignment>;
    ...
    'Option<CurrencyIdentifier>': Option<CurrencyIdentifier>;
    'Vec<CurrencyIdentifier>': Vec<CurrencyIdentifier>;
    ...
    CurrencyCeremony: CurrencyCeremony;
    'Option<CurrencyCeremony>': Option<CurrencyCeremony>;
    'Vec<CurrencyCeremony>': Vec<CurrencyCeremony>;
    CurrencyPropertiesType: CurrencyPropertiesType;
    'Option<CurrencyPropertiesType>': Option<CurrencyPropertiesType>;
    'Vec<CurrencyPropertiesType>': Vec<CurrencyPropertiesType>;
    Demurrage: Demurrage;
    ...
    'Option<GetterArgs>': Option<GetterArgs>;
    'Vec<GetterArgs>': Vec<GetterArgs>;
    Enclave: Enclave;
    'Option<Enclave>': Option<Enclave>;
    'Vec<Enclave>': Vec<Enclave>;
    PublicGetter: PublicGetter;
    'Option<PublicGetter>': Option<PublicGetter>;
    'Vec<PublicGetter>': Vec<PublicGetter>;
    ...
    Getter: Getter;
    'Option<Getter>': Option<Getter>;
    'Vec<Getter>': Vec<Getter>;

...
import { stringToDegree, stringToEncointerBalance } from "../../types/src";
import { cryptoWaitReady } from "@polkadot/util-crypto";
import { submitAndWatchTx } from "./tx";
import { getAssignment, getAssignmentCount, getDemurrage, getMeetupCount, getMeetupIndex, getMeetupLocation, getMeetupParticipants, getCeremonyIncome, getParticipantIndex, getStartOfAttestingPhase, getParticipantRegistration, getMeetupTimeOffset, } from './encointer-api.js';
describe('node-api', () => {
    let keyring;
    let api;
    let cidMTA;

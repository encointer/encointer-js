 ...
 */
export function assignmentFn(participantIndex, assignmentParams, assignmentCount) {
...
export function getRegistration(pIndexes) {
 ...
 */
export function computeMeetupIndex(registration, assignments, assignmentCount, meetupCount) {
 ...
 * @param meetupCount
 */
export function meetupIndex(participantIndex, assignmentParams, meetupCount) {
 ...
 */
export function meetupLocation(meetupIndex, locations, locationAssignmentParams) {
 ...
 */
export function meetupTime(location, attesting_start, one_day, offset) {
...
export function computeStartOfAttestingPhase(currentPhase, nextPhaseStart, assigningDuration, attestingDuration) {
 ...
 */
export function assignmentFnInverse(meetupIndex, assignmentParams, assignmentCount, participantCount) {
    const registry = meetupIndex.registry;
...
export function modInv(a, module) {
    let mn = [module, a];
    let xy = [0, 1];
    while (mn[1] != 0) {
